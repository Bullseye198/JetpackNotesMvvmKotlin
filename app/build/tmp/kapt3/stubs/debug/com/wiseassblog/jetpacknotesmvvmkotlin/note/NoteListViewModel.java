...
public final class NoteListViewModel extends com.wiseassblog.jetpacknotesmvvmkotlin.common.BaseViewModel<com.wiseassblog.jetpacknotesmvvmkotlin.note.notelist.NoteListEvent> {
    private final androidx.lifecycle.MutableLiveData<java.util.List<com.example.domain.note.Note>> noteListState = null;
    ...
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<java.util.List<com.example.domain.note.Note>> getNoteList() {
        return null;
    }
