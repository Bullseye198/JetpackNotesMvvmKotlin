...
public final class NoteRepoImpl implements com.wiseassblog.jetpacknotesmvvmkotlin.model.repository.INoteRepository {
    ...
    kotlin.coroutines.Continuation<? super com.wiseassblog.jetpacknotesmvvmkotlin.common.Result<? extends java.lang.Exception, com.example.domain.note.Note>> p1) {
        return null;
    }
    ...
    com.example.domain.note.Note note, @org.jetbrains.annotations.NotNull()
    ...
    kotlin.coroutines.Continuation<? super com.wiseassblog.jetpacknotesmvvmkotlin.common.Result<? extends java.lang.Exception, ? extends java.util.List<com.example.domain.note.Note>>> p0) {
        return null;
    }
     ...
     */
    private final com.example.domain.user.User getActiveUser() {
        return null;
    }
    
    private final com.wiseassblog.jetpacknotesmvvmkotlin.common.Result<java.lang.Exception, java.util.List<com.example.domain.note.Note>> resultToNoteList(com.google.firebase.firestore.QuerySnapshot result) {
        return null;
    }
